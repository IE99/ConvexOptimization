...
for i = 1:numParticles
    if i == 1
        ...
        trial     = max(eps_min, min(eps_max, trial));
        positions(i,:) = trial;
    end
...
figure('Name','Final Results - Sawtooth Field','Color','w');
...
title('Target vs Optimized vs Filtered Fields');
